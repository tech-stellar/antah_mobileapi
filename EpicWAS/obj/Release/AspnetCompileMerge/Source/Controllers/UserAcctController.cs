...
namespace EpicWAS.Controllers
{
    ...
    public class UserAcctController : ApiController
    {
        ...
        public HttpResponseMessage VerifyUserLogin(string strUID, string strPass, string strEnvId, string strImei = "")
        {
            string strReturnMsg;
            ...
            if (IsComplete)
            {
                ...
                IsValidIMEI = oEpicUserBO._VerifyIMEI(ref oEpicorEnv, ref oEpicUser, out strReturnMsg);
                ...
                if (IsLogin)
                {
                    ...
                    return Request.CreateResponse(HttpStatusCode.OK, oEpicUser);
                }
                else
                {
                    HttpError err = new HttpError(strReturnMsg);
        ...
        public HttpResponseMessage LoadEpicUserCompany(string strUId, string strPass, string strEnvId)
        {
            string strReturnMsg;
            ...
            if (IsLoadEnvOK == true)
            {
                ...
                if (IsLogin)
                {
                    IsLoadUserOK = oEpicUserBO._LoadEpicUserByUserId(strUId, ref oEpicEnv, ref oEpicUser, out strReturnMsg);
        ...
        public HttpResponseMessage LoadEpicCompanyAndPlantByUserId(string strUId, string strPass, string strEnvId)
        {
            string strReturnMsg;
            bool IsLoadEnvOK = false;
            bool IsLoadUserOK = false;
        ...
        [HttpGet]
        [ActionName("LoadPlantByCompanyId")]
        public HttpResponseMessage LoadPlantByCompanyId(string strUId, string strPass, string strEnvId, string strCompanyId)
        {
            string strReturnMsg;
            bool IsLoadEnvOK = false;
            bool IsLoadUserOK = false;
            bool IsLoadPlant = false;
            IList<Plant> lstPlant = new List<Plant>();
            ...
            if (IsLoadEnvOK == true)
            {
                ...
                if (IsLoadUserOK == true)
                {
                    IsLoadPlant = oEpicUserBO._LoadEpicCompanyPlantByCompanyId(ref oEpicEnv, ref oEpicUser, strCompanyId, ref lstPlant, out strReturnMsg);

                    if (IsLoadPlant == true)
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, lstPlant);
                    }
                    else
                    {
                        HttpError err = new HttpError(strReturnMsg);
        ...
        public HttpResponseMessage UpdateEpicEnvironment(string strEnvId, string strEnvName, bool blIsActive, 
                                                             ...
                                                             string strRESTURL = "", string strRESTKEY = "")
        {
            string strReturnMsg;
            bool IsComplete = false;
            ...
            oEpicEnv.Env_RESTAPIURL = strRESTURL;
            oEpicEnv.Env_RESTAPIKEY = strRESTKEY;
